...
# Inner loop
Before writing code, read and follow \`$FM_ROOT/.agents/skills/pstack-inner-loop/SKILL.md\` - smallest change, proven artifact; no second router, no extra review pass.
